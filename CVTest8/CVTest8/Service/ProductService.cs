    ...
    public class ProductService
    {
        public List<Product> GetProductList()
        {
            return new List<Product>()
            {
                ...
                new Product(){ProductName="Large Boost Package", ProductDescription="Provices 65 of each boost type", Price=25, ImageUrl="boost3", ProductID="boost3"},
                ...
                new Product(){ProductName="Video Advertisement", ProductDescription="Provides 4 random boosts after watching",Price=0, ImageUrl="rewardedAd", ProductID="rewardedAd"},
